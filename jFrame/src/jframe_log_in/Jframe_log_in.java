...
import jframe_main.Jframe_main;
import jframe_sign_in.Jframe_sign_in;
...
//	private static final long serialVersionUID = 1L;
	...
	private void jbInit()
	{
		...
		jButton1.setBounds(new Rectangle(30,250,100,45));
		...
		jButton2.setBounds(new Rectangle(270,250,100,45));
		
		jButton3.setText("registry");
		jButton3.setBounds(new Rectangle(150,250,100,45));
		jButton3.setFont(new Font("楷体",Font.PLAIN,16));
		jButton3.setForeground(Color.DARK_GRAY);
		jButton3.addActionListener(new SimpleListener3(this));
	...
	public void jButton3_action_performed(ActionEvent actionEvent)
	{
		this.dispose();
		new Jframe_sign_in();
	}
